...
let g:python3_host_prog = '/Users/tong/miniforge3/envs/torch/bin/python'
let g:coc_global_extensions = ['coc-explorer', 'coc-json', 'coc-tsserver', 'coc-eslint', 'coc-snippets', 'coc-html', 'coc-css', 'coc-pyright', 'coc-git']
